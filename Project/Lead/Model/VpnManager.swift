...
extension VpnManager{
    ...
    fileprivate func createProviderManager() -> NETunnelProviderManager {
        ...
        conf.serverAddress = "Lead"
        manager.protocolConfiguration = conf
        manager.localizedDescription = "Lead VPN"
        return manager
    }
...
extension VpnManager{
    ...
    fileprivate func setRulerConfig(_ manager:NETunnelProviderManager){
        ...
        conf["ss_address"] = UserDefaults.standard.string(forKey: "address") as AnyObject?
        conf["ss_port"] = Int(UserDefaults.standard.string(forKey: "port")!) as AnyObject?
        conf["ss_method"] = UserDefaults.standard.string(forKey: "method") as AnyObject? // 大写 没有横杠 看Extension中的枚举类设定 否则引发fatal error
        conf["ss_password"] = UserDefaults.standard.string(forKey: "password") as AnyObject?
